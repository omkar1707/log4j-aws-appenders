...
//----------------------------------------------------------------------------
    ...
    {
        DefaultClientFactory<AWSLogs> factory = new DefaultClientFactory<AWSLogs>(AWSLogs.class, null, null, null, logger, null, null)
        {
            @Override
    ...
    public void testStaticClientFactory() throws Exception
    {
        ...
        DefaultClientFactory<AWSLogs> factory = new DefaultClientFactory<AWSLogs>(AWSLogs.class, factoryMethodName, null, null, logger, null, null)
        {
            @Override
            public AWSLogs tryBuilder()
            {
    ...
    public void testClientBuilderWithRegion() throws Exception
    {
        ...
        DefaultClientFactory<AWSLogs> factory = new DefaultClientFactory<AWSLogs>(AWSLogs.class, null, region, null, logger, null, null)
        {
            // for this test we want to exercise the full builder code path
            {
                factoryClasses.put("com.amazonaws.services.logs.AWSLogs", MockClientBuilder.class.getName());
    ...
    public void testClientConstructorWithExplicitEndpoint() throws Exception
    {
        ...
        // we're using an actual client, not a mock
        DefaultClientFactory<AWSLogs> factory = new DefaultClientFactory<AWSLogs>(AWSLogs.class, null, null, endpoint, logger, null, null);
